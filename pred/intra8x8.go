...
func PredIntra8x8WithTopRight(pred []uint8, mode int, top, left []uint8, topLeft uint8, hasTopRight bool) {
	...
	case Intra4x4VerticalRight:
		...
		set(0, 6, (l[5]+2*l[4]+l[3]+2)>>2)
		set(0, 7, (l[6]+2*l[5]+l[4]+2)>>2)
		set(0, 4, (l[3]+2*l[2]+l[1]+2)>>2)
		set(1, 6, (l[3]+2*l[2]+l[1]+2)>>2)
		set(0, 5, (l[4]+2*l[3]+l[2]+2)>>2)
		set(1, 7, (l[4]+2*l[3]+l[2]+2)>>2)
		set(0, 2, (l[1]+2*l[0]+lt+2)>>2)
		set(1, 4, (l[1]+2*l[0]+lt+2)>>2)
		set(2, 6, (l[1]+2*l[0]+lt+2)>>2)
		set(0, 3, (l[2]+2*l[1]+l[0]+2)>>2)
		set(1, 5, (l[2]+2*l[1]+l[0]+2)>>2)
		set(2, 7, (l[2]+2*l[1]+l[0]+2)>>2)
		set(0, 1, (l[0]+2*lt+t[0]+2)>>2)
		set(1, 3, (l[0]+2*lt+t[0]+2)>>2)
		set(2, 5, (l[0]+2*lt+t[0]+2)>>2)
		set(3, 7, (l[0]+2*lt+t[0]+2)>>2)
		set(0, 0, (lt+t[0]+1)>>1)
		set(1, 2, (lt+t[0]+1)>>1)
		set(2, 4, (lt+t[0]+1)>>1)
		set(3, 6, (lt+t[0]+1)>>1)
		set(1, 1, (lt+2*t[0]+t[1]+2)>>2)
		set(2, 3, (lt+2*t[0]+t[1]+2)>>2)
		set(3, 5, (lt+2*t[0]+t[1]+2)>>2)
		set(4, 7, (lt+2*t[0]+t[1]+2)>>2)
		set(1, 0, (t[0]+t[1]+1)>>1)
		set(2, 2, (t[0]+t[1]+1)>>1)
		set(3, 4, (t[0]+t[1]+1)>>1)
		set(4, 6, (t[0]+t[1]+1)>>1)
		set(2, 1, (t[0]+2*t[1]+t[2]+2)>>2)
		set(3, 3, (t[0]+2*t[1]+t[2]+2)>>2)
		set(4, 5, (t[0]+2*t[1]+t[2]+2)>>2)
		set(5, 7, (t[0]+2*t[1]+t[2]+2)>>2)
		set(2, 0, (t[1]+t[2]+1)>>1)
		set(3, 2, (t[1]+t[2]+1)>>1)
		set(4, 4, (t[1]+t[2]+1)>>1)
		set(5, 6, (t[1]+t[2]+1)>>1)
		set(3, 1, (t[1]+2*t[2]+t[3]+2)>>2)
		set(4, 3, (t[1]+2*t[2]+t[3]+2)>>2)
		set(5, 5, (t[1]+2*t[2]+t[3]+2)>>2)
		set(6, 7, (t[1]+2*t[2]+t[3]+2)>>2)
		set(3, 0, (t[2]+t[3]+1)>>1)
		set(4, 2, (t[2]+t[3]+1)>>1)
		set(5, 4, (t[2]+t[3]+1)>>1)
		set(6, 6, (t[2]+t[3]+1)>>1)
		set(4, 1, (t[2]+2*t[3]+t[4]+2)>>2)
		set(5, 3, (t[2]+2*t[3]+t[4]+2)>>2)
		set(6, 5, (t[2]+2*t[3]+t[4]+2)>>2)
		set(7, 7, (t[2]+2*t[3]+t[4]+2)>>2)
		set(4, 0, (t[3]+t[4]+1)>>1)
		set(5, 2, (t[3]+t[4]+1)>>1)
		set(6, 4, (t[3]+t[4]+1)>>1)
		set(7, 6, (t[3]+t[4]+1)>>1)
		set(5, 1, (t[3]+2*t[4]+t[5]+2)>>2)
		set(6, 3, (t[3]+2*t[4]+t[5]+2)>>2)
		set(7, 5, (t[3]+2*t[4]+t[5]+2)>>2)
		set(5, 0, (t[4]+t[5]+1)>>1)
		set(6, 2, (t[4]+t[5]+1)>>1)
		set(7, 4, (t[4]+t[5]+1)>>1)
		set(6, 1, (t[4]+2*t[5]+t[6]+2)>>2)
		set(7, 3, (t[4]+2*t[5]+t[6]+2)>>2)
		set(6, 0, (t[5]+t[6]+1)>>1)
		set(7, 2, (t[5]+t[6]+1)>>1)
		set(7, 1, (t[5]+2*t[6]+t[7]+2)>>2)
		set(7, 0, (t[6]+t[7]+1)>>1)
