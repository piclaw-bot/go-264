...
s = s.replace('{ int _pmx = mx, _pmy = my; DECODE_CABAC_MB_MVD(sl, list, 0)\n', '{ int _pmx = mx, _pmy = my; int _amvdX = sl->mvd_cache[list][scan8[0]-1][0] + sl->mvd_cache[list][scan8[0]-8][0]; int _amvdY = sl->mvd_cache[list][scan8[0]-1][1] + sl->mvd_cache[list][scan8[0]-8][1]; DECODE_CABAC_MB_MVD(sl, list, 0)\n')
s = s.replace('{ int _pmx = mx, _pmy = my; DECODE_CABAC_MB_MVD(sl, list, 8*i)\n', '{ int _pmx = mx, _pmy = my; int _idx = 8*i; int _amvdX = sl->mvd_cache[list][scan8[_idx]-1][0] + sl->mvd_cache[list][scan8[_idx]-8][0]; int _amvdY = sl->mvd_cache[list][scan8[_idx]-1][1] + sl->mvd_cache[list][scan8[_idx]-8][1]; DECODE_CABAC_MB_MVD(sl, list, 8*i)\n')
s = s.replace('{ int _pmx = mx, _pmy = my; DECODE_CABAC_MB_MVD(sl, list, 4*i)\n', '{ int _pmx = mx, _pmy = my; int _idx = 4*i; int _amvdX = sl->mvd_cache[list][scan8[_idx]-1][0] + sl->mvd_cache[list][scan8[_idx]-8][0]; int _amvdY = sl->mvd_cache[list][scan8[_idx]-1][1] + sl->mvd_cache[list][scan8[_idx]-8][1]; DECODE_CABAC_MB_MVD(sl, list, 4*i)\n')
...
s = s.replace('list, mpx, mpy, mx-_pmx, my-_pmy, _pmx, _pmy, mx, my);', 'list, _amvdX, _amvdY, mpx, mpy, mx-_pmx, my-_pmy, _pmx, _pmy, mx, my);')
s = s.replace('i, list, mpx, mpy, mx-_pmx, my-_pmy, _pmx, _pmy, mx, my);', 'i, list, _amvdX, _amvdY, mpx, mpy, mx-_pmx, my-_pmy, _pmx, _pmy, mx, my);')
p.write_text(s)
PY
}
