...
s = re.sub(
    ...
    'fprintf(stderr, "FFCOLZERO8 mb=%04d i8=%d coltype0=%d coltype1=%d colref0=%d colref1=%d colmv={%d,%d} ref0=%d ref1=%d mv0={%d,%d} mv1={%d,%d} is_b8x8=%d sub_type=%u mb_type=%d\\\\n",\\n                                sl->mb_x + sl->mb_y * h->mb_width, i8, mb_type_col[0], mb_type_col[1], l1ref0[i8], l1ref1[i8], mv_col[0], mv_col[1], ref[0], ref[1],\\n                                (int16_t)mv[0], (int16_t)(mv[0] >> 16), (int16_t)mv[1], (int16_t)(mv[1] >> 16), is_b8x8, sub_mb_type, *mb_type);',
    s,
    flags=re.S)
s = s.replace(
...
s = re.sub(
    ...
    'fprintf(stderr, "FFCOLZERO mb=%04d i8=%d i4=%d coltype0=%d coltype1=%d colref0=%d colref1=%d colmv={%d,%d} ref0=%d ref1=%d mv0={%d,%d} mv1={%d,%d} is_b8x8=%d sub_type=%u mb_type=%d\\\\n",\\n                                    sl->mb_x + sl->mb_y * h->mb_width, i8, i4, mb_type_col[0], mb_type_col[1], l1ref0[i8], l1ref1[i8], mv_col[0], mv_col[1], ref[0], ref[1],\\n                                    (int16_t)mv[0], (int16_t)(mv[0] >> 16), (int16_t)mv[1], (int16_t)(mv[1] >> 16), is_b8x8, sub_mb_type, *mb_type);',
    s,
    flags=re.S)
s = s.replace(
