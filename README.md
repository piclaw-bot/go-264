...
- `GO264_RECON_TRACE=1` — reconstruction checksums for luma Intra_8x8 and chroma prediction/residual/output, including per-4×4 prediction/residual/output and pre-IDCT coefficient sums
