...
- `GO264_RECON_TRACE=1` — reconstruction checksums for luma Intra_8x8 and chroma prediction/residual/output, including syntax vs reconstruction modes, raw row-major coefficients, FFmpeg-storage raw coefficient view, dequantized coefficients, per-4×4 prediction/residual/output, and pre/post-IDCT sums
